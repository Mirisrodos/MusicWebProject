          ...
          <div class="music-list">
            ...
            <c:forEach items="${listSong}" var="song"> 
                ...
                <td class="headersong">
                  <img src="img/songImg/${song.getSongId()}.jpg" alt="">
                  <div>
                    <a href="songdetail?songid=${song.getSongId()}" style="text-decoration:none; color:white">${song.getName()}</p>
                  </div>
                </td>
                <td class="favorite"><i class="bi bi-heart"></i></td>
                <td class="menu"><i class="bi bi-three-dots"></i></td>
                <td><i style="position:absolute; left: 10px; top:50%; transform: translateY(-50%); padding: 18px 18px; background-color: rgba(0,0,0,0.2);" class="bi playListPlay bi-play-circle-fill play-btn" id="${song.getSongId() }"></i></td>
              </tr>
