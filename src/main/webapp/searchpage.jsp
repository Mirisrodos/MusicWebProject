					...
					<div class="main-scroll">
						<div class="search-result">
							...
							<div class="no1search">
								...
								<c:if test="${!songList.isEmpty()}">
									<div class="song-image">
										...
										<h1 style="margin: 0; ">${firstSong.getName()}</h1>
									</div>
									<h1></h1>
									<div class="song-info">
									...
									<i style="background-color: transparent; font-size:50px; color: #36e2ec"
										class="bi playListPlay bi-play-circle-fill play-btn"
										id="${firstSong.getSongId() }"></i>
								</c:if>
								<c:if test="${songList.isEmpty()}">
							...
							<div class="searched-list">
											...
											<li>
												<div class="song-info">
													...
													<div class="detail">
														...
														<p>${song.getSingers().getName() }</p>
													</div>
													<div class="play-btn">
														<i class="bi playListPlay bi-play-circle-fill play-btn"
															id="${song.getSongId() }"></i>
													</div>
												</div>
												<div class="last-info">
													<button class="heart-btn" style="margin-right: 20px">
								...
								<c:if test="${songList.isEmpty()}">
									<div style="margin:auto; opacity: 0.7; height: 230px; overflow:hidden">Not Found!
									</div>
								</c:if>
							</div>
						...
						<div class="searched-album">
							<h2>Singer</h2>
							<c:if test="${!singersList.isEmpty()}">
								<div class="row">
									<c:forEach items="${singersList}" var="singer">
										<div class="col">
											<a href="singerdetail?singerid=${singer.getSingerId()}">
												<img src="./img/singerImg/${singer.getSingerId()}.jpg">
												<div class="album-info">
													<h2 style="color:white">${singer.getName()}</h2>
													<p style="color:white">${singer.getDecription()}</p>
												</div>
											</a>
										</div>
							...
							<c:if test="${singersList.isEmpty()}">
								<div style="margin:auto; opacity: 0.7; height: 110px; overflow:hidden">Không tìm thấy
									bài hát</div>
							</c:if>
						</div>
