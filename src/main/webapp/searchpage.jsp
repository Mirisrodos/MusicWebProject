 ...
 <c:if test="${empty sessionScope.userid }">
   ...
   first
      ...
      <div class="song_side">
	              ...
	              <c:forEach items="${songList}" var="song"> 
					 <li>
	                  <div class="song-info">
	                    ...
	                    <div class="play-btn">
	                    	<i  class="bi playListPlay bi-play-circle-fill play-btn" id="${song.getSongId() }"></i>
	                    </div>
	                  </div>
	                  <div class="last-info">
        ...
        <c:if test="${singersList.isEmpty()}">
        <div style="margin:auto; opacity: 0.7; height: 110px; overflow:hidden">Không tìm thấy bài hát</div> 
        </c:if>
      </div>
