			...
			<header>
				<div class="menu_side">
					...
					<c:if test="${!empty sessionScope.userid }">
						<ul class="menu_song">
							<c:forEach items="${userListSong}" var="song" varStatus="loop">
								<li class="songItem"><a href="songdetail?songid=${song.getSongId()}"> <span>${loop.count.toString()}</span>
										<img src="img/songImg/${song.getSongId()}.jpg" alt="" />
										<h5>
											${song.getName()} <br />
											<div class="subtitle">${song.getSingers().getName() }</div>
										</h5>
									</a> <i class="bi playListPlay bi-play-circle-fill" id="${song.getSongId()}"></i>
								</li>
							</c:forEach>
						</ul>
					</c:if>
					...
					<c:if test="${empty sessionScope.userid }">
						<div style="margin-top: 100px; margin-left: 20px; color: #4c5262;" class="need-to-login">
							Getting started by <a style="color: #36e2ec; text-decoration: none;" href="login">Login</a>
							or <a style="color: #36e2ec; text-decoration: none; opacity: 0.7"
				...
				<div class="song_side">
					...
					<nav>
						...
						<c:if test="${empty sessionScope.userid }">
							<div class="user">
								<span> <a class="login" href="login">Login</a> <a class="register"
							...
							<div class="pop_song">
								<c:forEach items="${listSong}" var="song">
									<li class="songItem">
										...
										<div class="img_play">
											<img src="img/2.jpg" alt="" /> <i class="bi playListPlay bi-play-circle-fill" id="9"></i>
							...
							<ul style="height: 250px" class="item">
								<c:forEach items="${listSinger}" var="singer">
									<li><a style="text-decoration: none"
											...
											<h5
												style="padding: 5px 0px 0px 5px; line-height: 15px; font-size: 14px; width: 100px; margin-top: 8px; color: white">
												${singer.getName()}</h5>
										</a></li>
								</c:forEach>
						</div>
				...
				<div class="master_play">
					...
					<div class="player">
						<div class="icon">
							<i class="bi Shuffle bi-music-note-beamed">next</i> <i class="bi bi-skip-start-fill"
								id="back"></i> <i class="bi bi-play-fill" id="masterPlay"></i> <i
								class="bi bi-skip-end-fill" id="next"></i> <i class="bi bi-cloud-arrow-down-fill"
								id="download_music"></i>
						</div>
					...
					<div class="vol">
						<i class="bi bi-volume-up-fill" id="vol_icon"></i> <input type="range" min="0" max="100"
							id="vol" />
