      ...
      <div class="song_side">
        ...
        <div class="main-scroll">
            ...
            <div class="info">
              ...
              <div class="Fb61sprjhh75aOITDnsJ">
                <span class="Type__TypeElement-goli3j-0 hWmToD">
                  <a draggable="false" data-testid="creator-link" href="singerdetail?singerid=${songDetail.getSingers().getSingerId() }">${songDetail.getSingers().getName()},</a>
                </span>
          ...
          <div class="option-buttons">
            <i style="font-size: 55px;margin-right: 30px; color: #36e3ec;" class="bi playListPlay bi-play-circle-fill" id="${songDetail.getSongId()}"></i>
